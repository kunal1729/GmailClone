  ...
  return (
    <div className='p-4 w-[20%] space-y-2 text-sm flex flex-col'>
      ...
      <div className='space-y-3 ml-2'>
        ...
        <button onClick={() => setType("Drafts")} className={`${type === "Drafts" ? "bg-[#d8e4fc] p-2 mx-auto w-fit md:w-full rounded-full font-bold flex space-x-4 content-start text-center" : 'flex space-x-4 mx-auto md:mx-0 content-start'} `}>
          <Drafts/>
          <span className='text-sm hidden md:inline'>Drafts</span>
        </button>
