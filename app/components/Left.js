...
const Left = () => {
  return (
    <div className='w-16  cursor-pointer flex space-y-4 p-4 flex-col'>
        <button className=' mx-auto p-3 rounded-2xl  bg-[#c2e7ff]'>
        ...
        <button className='flex mx-auto content-start'>
